...
[![Version](https://img.shields.io/badge/version-2.0.3-22c55e?style=flat-square)](https://github.com/evnrca/DungeonRooms)
...
```yaml
# DungeonRooms v2.0.3 Configuration
death-override:
...
```text
build/libs/DungeonRooms-2.0.3.jar
```
